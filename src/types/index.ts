...
export interface HomepageConfig {
  ...
  mat_title: string;
  mat_subtitle: string;
  mat_intro_title: string;
  mat_intro_desc: string;
  mat_commit_title: string;
  mat_commit_desc: string;
  env_free_text: string;
  env_free_sub: string;
  env_int_title: string;
  env_int_desc: string;
  env_cta_title: string;
  env_cta_desc: string;
  care_intro_title: string;
  care_intro_desc: string;
