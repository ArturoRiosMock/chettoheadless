...
export default function TestimonialCard({ testimonial }: TestimonialCardProps) {
  return (
    <div className="flex flex-col rounded-2xl bg-white p-6 shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.1)]">
      <div
      ...
      <p className="mt-8 flex-1 text-[14px] font-normal leading-[22.75px] tracking-[-0.15px] text-[#6b6b6b]">
        {testimonial.text}
      </p>

      <div className="mt-6 flex items-center gap-3">
        <div
          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#c4b5a0] text-base leading-6 tracking-[-0.31px] text-white"
          aria-hidden="true"
        >
          {testimonial.initial}
        </div>
        <div>
          <p className="text-[14px] font-normal leading-5 tracking-[-0.15px] text-[#2d2d2d]">
            {testimonial.name}
          </p>
